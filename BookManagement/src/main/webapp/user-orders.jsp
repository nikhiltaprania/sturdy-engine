...
<div class="container p-1">
    ...
    <table class="table table-striped m-3">
        ...
        <%
            ...
            List<Orders> orders = new UserCartDAOImpl().getAllOrdersOfAUser(user.getUserId()).reversed();
        ...
        <tr>
            ...
            <td><a href="single-order-page.jsp?orderId=<%= order.getOrderId() %>" class="btn btn-sm btn-primary"><i
